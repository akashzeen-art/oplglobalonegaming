...
type Lang = "en" | "fr" | "ar" | "es" | "rn" | "lo" | "sw" | "pl";
...
const translations: Record<Lang, Translations> = {
  ...
  fr: {
    ...
    welcomeTo: "Bienvenue sur Global 1 Gaming",
    experienceUltimate: "Viv<b>e</b>z la plateforme <br /> de jeu ulti<b>m</b>e",
    whereEvery: "Où chaque jeu est une aventure à conquérir",
    instantAccess: "Global 1 Gaming vous offre un accès instantané à des centaines de jeux dans tous les genres.",
    ...
    allRights: "©Global 1 Gaming 2026. Tous droits réservés",
  },
  ar: {
    playNow: "العب الآن",
    home: "الرئيسية",
    games: "الألعاب",
    categories: "الفئات",
    welcomeTo: "مرحباً بك في Global 1 Gaming",
    experienceUltimate: "اختب<b>ر</b> منصة <br /> الألع<b>ا</b>ب المثالية",
    whereEvery: "حيث كل لعبة مغامرة تنتظر أن تُفتح",
    instantAccess: "يمنحك Global 1 Gaming وصولاً فورياً لمئات الألعاب عبر جميع الأنواع.",
    ...
    allRights: "©Global 1 Gaming 2026. جميع الحقوق محفوظة",
  },
  es: {
    playNow: "Jugar Ahora",
    home: "Inicio",
    ...
    welcomeTo: "Bienvenido a Global 1 Gaming",
    ...
    instantAccess: "Global 1 Gaming te brinda acceso instantáneo a cientos de juegos en todos los géneros.",
    ...
    allRights: "©Global 1 Gaming 2026. Todos los derechos reservados",
  },
  rn: {
    playNow: "Kina Ubu",
    home: "Ahabanza",
    games: "Imikino",
    categories: "Ibice",
    welcomeTo: "Murakaza neza kuri Global 1 Gaming",
    ...
    instantAccess: "Global 1 Gaming ikugenera uburyo bwo gukina ako kanya imikino amajana mu bice vyose.",
    ...
    allRights: "©Global 1 Gaming 2026. Uburenganzira bwose bubungabunzwe",
  },
  lo: {
    playNow: "ຫຼິ້ນຕອນນີ້",
    home: "ໜ້າຫຼັກ",
    games: "ເກມ",
    categories: "ໝວດໝູ່",
    welcomeTo: "ຍິນດີຕ້ອນຮັບສູ່ Global 1 Gaming",
    experienceUltimate: "ສໍາຜັດແພລດຟອຣ<b>ມ</b> <br /> ເກມທີ່ດີທີ່ສຸດ",
    whereEvery: "ບ່ອນທີ່ທຸກເກມເປັນການຜະຈົນໄພທີ່ລໍຖ້າການພິຊິດ",
    instantAccess: "Global 1 Gaming ໃຫ້ທ່ານເຂົ້າເຖິງເກມຫຼາຍຮ້ອຍເກມໃນທຸກໝວດໝູ່ໄດ້ທັນທີ.",
    ...
    allRights: "©Global 1 Gaming 2026. ສະຫງວນລິຂະສິດທັງໝົດ",
  },
  sw: {
    playNow: "Cheza Sasa",
    home: "Nyumbani",
    ...
    welcomeTo: "Karibu kwenye Global 1 Gaming",
    ...
    instantAccess: "Global 1 Gaming inakupa ufikiaji wa papo hapo wa mamia ya michezo katika kategoria zote.",
    ...
    allRights: "©Global 1 Gaming 2026. Haki zote zimehifadhiwa",
  },
  pl: {
    playNow: "Graj Teraz",
    home: "Strona główna",
