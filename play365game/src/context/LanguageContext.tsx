...
const translations: Record<Lang, Translations> = {
  en: {
    ...
    welcomeTo: "Welcome to Global One Gaming",
    ...
    instantAccess: "Global One Gaming brings you instant access to hundreds of games across all genres, from action-packed shooters to brain-teasing puzzles",
    ...
    allRights: "©Global One Gaming 2026. All rights reserved",
  },
  pl: {
    playNow: "Graj Teraz",
    home: "Strona główna",
    ...
    welcomeTo: "Witamy w Global One Gaming",
    ...
    instantAccess: "Global One Gaming daje Ci natychmiastowy dostęp do setek gier we wszystkich gatunkach, od dynamicznych strzelanek po łamigłówki.",
    ...
    allRights: "©Global One Gaming 2026. Wszelkie prawa zastrzeżone",
  },
};
